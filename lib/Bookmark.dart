                ...
                Column(
                  children: <Widget>[
                        ...
                        Container(
                          ...
                          child: Text('Jaipur’s BattRE Launches LoEV Electric Scooter',overflow: TextOverflow.ellipsis,style: TextStyle(fontSize: 14,fontWeight: FontWeight.w500,color: Color(0XFF4181ee)),),
                        ...
                        Container(
                          ...
                          child: Text('By Sam',overflow: TextOverflow.ellipsis,style: TextStyle(fontSize: 14,fontWeight: FontWeight.w500,color: Color(0XFF4181ee).withOpacity(0.7)),),
